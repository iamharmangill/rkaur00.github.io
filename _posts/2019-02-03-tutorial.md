...
Now first I am going to build **index.ejs** file which is under **views** folder. As defined earlier, views are used to display user interface. I am using embedded JavaScript file that contains bootstrap along with JavaScript functionality.
