...
-run the code by typing **node server.js** and you will get the data of **data.json** in terminal. So, upto now we are successfull in reading the content of external file. 
